...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаНастройкаОтключенияФормированияВФоне.Видимость = НЕ ИнформационнаяБазаФайловая;
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ПовышающийКоэффициент"            , Отчет.ПовышающийКоэффициент);
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	Если ИнформационнаяБазаФайловая ИЛИ Отчет.ФормироватьБезФоновогоЗадания Тогда
