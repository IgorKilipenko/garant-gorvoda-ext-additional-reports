...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	ПараметрыОтчета = Отчеты.lc_РасчетАмортизацииКТарифам.ПустыеПараметрыКомпоновкиОтчета();
	Отчеты.lc_РасчетАмортизацииКТарифам.ЗаполнитьПараметрыИзФормы(ПараметрыОтчета, ЭтотОбъект);
...
Процедура ИнициализацияКомпоновщикаНастроек()
	...
	БухгалтерскиеОтчетыВызовСервера.ИнициализацияКомпоновщикаНастроек(ЭтотОбъект, ОрганизацияИзменилась, "lc_РасчетАмортизацииКТарифам");
