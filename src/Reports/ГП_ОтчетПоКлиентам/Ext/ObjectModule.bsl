...
Функция УточнитьПараметрыПериодаОтчета()
    ...
    БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(
        ЭтотОбъект.КомпоновщикНастроек.Настройки, "НачалоПериода", Новый Граница(РезультатФункции.ДатаНачала, ВидГраницы.Включая));
    БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(
        ЭтотОбъект.КомпоновщикНастроек.Настройки, "КонецПериода", Новый Граница(РезультатФункции.ДатаОкончания, ВидГраницы.Включая));
