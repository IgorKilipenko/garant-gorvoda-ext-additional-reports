...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    ЗначениеПараметраВидЗадолженности = ПолучитьЗначениеПараметраПоНаименованию("ВидЗадолженности", Ложь);
    ОбщиеДанныеОтчета = Новый Структура("Дата, Организация, ФорматЗадолженности, ДляПечати, ВидЗадолженности",
