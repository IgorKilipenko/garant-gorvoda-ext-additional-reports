...
Процедура ИнициализироватьПараметры()
    ...
    // Будет исключено (изменение текста запроса) не используется:
    //
    ...
    // ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ВТ_ГП_ВидыТарифовПотребителейЛицевыхСчетов###",
    //         "РегистрСведений.ГП_ВидыТарифовПотребителейЛицевыхСчетов.СрезПоследних(&КонецПериода, )");
