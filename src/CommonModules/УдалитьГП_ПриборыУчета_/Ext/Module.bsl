/////////////////////////////////////////////////////////////////////////
// !!! Этого модуля не должно быть в расширении ГП_ДополнительныеОтчеты
//  модуль (зачем-то) скопировали из расширения ГП_МиграцияБП77_Разработка и внесли дополнительные функции
/////////////////////////////////////////////////////////////////////////
...
Функция ПолучитьДанныеДляЗаполненияЗаводскихНомеровСчетчика()
    ...
    Для Каждого СтрокаДанных Из ДанныеСчетчиков Цикл
        СтруктураНомера = ПолучитьЗаводскойНомерИзКомментарияБП77(СтрокаДанных.ГП_Комментарий);
